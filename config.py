...
# 分割器数据路径（统一）
SEGMENTER_DATA_PATH = 'path/to/your/dataset'

# 模型保存路径
SEGMENT_MODEL_SAVE_PATH = 'cell_segmentation_model.pth'
...
VISUALIZATION_CONFIGS = {
    'colors': {
        "Koilocytotic": (255, 0, 0),      # 蓝色
        "Dyskeratotic": (0, 255, 0),      # 绿色
        "Metaplastic": (0, 0, 255),       # 红色
        "Parabasal": (255, 0, 255),       # 青色
